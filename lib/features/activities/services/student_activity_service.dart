...
class StudentActivityService {
  ...
  DocumentReference _getStudentActivityDoc(
    String schoolId,
  ...
  Stream<StudentActivity> getStudentActivity(
    String schoolId,
    String academicYearId,
    String studentId,
  ) {
    return _getStudentActivityDoc(
      schoolId,
      academicYearId,
      studentId,
    ).snapshots().map((doc) {
  ...
  Future<void> removeActivityEntry(
    String schoolId,
    String academicYearId,
    String studentId,
    ActivityEntry entry,
