...
class PaymentService {
  ...
  Future<void> approvePayment(
    ...
    if (payment.invoiceIds != null && payment.invoiceIds!.isNotEmpty) {
      ...
      for (int i = 0; i < payment.invoiceIds!.length; i++) {
        ...
        final amountPaidForThisInvoice =
            payment.invoiceAmounts != null && payment.invoiceAmounts!.length > i
        ...
        if (snap.exists) {
          ...
          final double newPaidAmount =
              invData.paidAmount + amountPaidForThisInvoice;
  ...
  Future<List<Payment>> getApprovedPaymentsByDateRange(
    String schoolId,
    String academicYearId,
    DateTime startDate,
    DateTime endDate,
  ...
  Stream<List<Payment>> getPaymentsForInvoice(
    String schoolId,
    String academicYearId,
    String invoiceId,
  ) {
